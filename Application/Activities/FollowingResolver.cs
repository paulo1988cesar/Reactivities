...
{
    public class FollowingResolver : IValueResolver<UserActivity, AttedeeDTO, bool>
    {
        ...
        public bool Resolve(UserActivity source, AttedeeDTO destination, bool destMember, ResolutionContext context)
        {
